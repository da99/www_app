...
To_HTML.string = function (val) { return HTML_Element('div', {},  val); };

To_HTML.form = function (form) {
  var arr = [];
  var err = null;
  var temp = null;
...
To_HTML.text_box = function (props) {
  var name         = props[0];
...
To_HTML.link = function (raw_props) {
