...
WWW_Applet.prototype.read_var = function (name) {
  return this.vars[WWW_Applet.standardize_name(name)];
};
...
WWW_Applet.prototype.eval_args = function (args) {
