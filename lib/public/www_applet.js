...
(function () {
  ...
  var get_tail_by_types = function (o, stack, types) {
    ...
    if (vals.length !== types.length) {
      throw new Error('Not enough right hand values.');
    }
    ...
    _.each(types, function (t, i) {
      ...
      if (!_.contains(any, t) && val.constructor !== t) {
        throw new Error("Right hand value is not a " + func_name(t) + ': ' + inspect(val));
      }
  ...
  var run_func = function (scope, name, args) {
    ...
    var o = {
      ...
      'right': function () {
        return get_tail_by_types(o, scope.stack, _.toArray(arguments));
      },

      'left': function () {
        return get_tail_by_types(o, o.run_args(), _.toArray(arguments));
      },
