...
(function () {
  ...
  var get_tail_by_types = function (o, stack, types, stack_name) {
    ...
    if (vals.length !== types.length) {
      throw new Error('Not enough in ' + stack_name + ' hand values.');
    }
    ...
    _.each(types, function (t, i) {
      ...
      if (!_.contains(any, t) && val.constructor !== t) {
        throw new Error(capitalize(stack_name) + " hand value is not a " + func_name(t) + ': ' + inspect(val));
      }
  ...
  var run_func = function (scope, name, args) {
    ...
    var o = {
      ...
      'right': function () {
        return get_tail_by_types(o, scope.stack, _.toArray(arguments), 'right');
      },

      'left': function () {
        return get_tail_by_types(o, o.run_args(), _.toArray(arguments), 'left');
      },
