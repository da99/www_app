    ...
    var run_func = function (name, raw_args) {
      ...
      switch (name) {
        ...
        case 'focus on ancestor':
          set('the focus', get('the focus').parents(left(String)));
          return get('the focus');

        case 'submit':
            var form   = $(get('the focus'));
        ...
        case 'add class':
          get('the focus').addClass(left(String));
          return left('last');
        ...
        case "on click":
          var focus  = get('the focus');
          var scope  = child();
          scope.set('the focus', focus);
